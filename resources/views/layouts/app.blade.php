                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                {{-- Profile Icon --}}
                                <a id="navbarDropdown" class="nav-link button" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
